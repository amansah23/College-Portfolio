    ...
    <section id="university" className="py-20 bg-gradient-to-b from-emerald-50/50 to-teal-50/30">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center mb-12">
          <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-100 text-orange-400 mb-4">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-12 transform transition-all hover:shadow-xl border border-purple-100">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/3 relative min-h-[300px]">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-transparent flex items-center justify-center md:opacity-0 md:hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="p-6 md:w-2/3 md:p-8">
              <h3 className="text-2xl font-bold text-orange-400 mb-2">{universityInfo.name}</h3>
              ...
              <Button
                className="bg-orange-400 hover:bg-orange-300 text-white transition-colors group"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-white rounded-xl p-8 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 border border-purple-50 group">
              <div className="p-4 bg-purple-50 rounded-2xl w-14 h-14 flex items-center justify-center mb-6 group-hover:bg-orange-400 transition-colors duration-300">
